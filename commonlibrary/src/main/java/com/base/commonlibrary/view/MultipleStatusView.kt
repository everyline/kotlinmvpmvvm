...
class MultipleStatusView : RelativeLayout {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(
        ...
        mEmptyViewResId =
            typedArray.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.empty_view)
        mErrorViewResId =
            typedArray.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.error_view)
        mLoadingViewResId = typedArray.getResourceId(
            R.styleable.MultipleStatusView_loadingView,
            R.layout.loading_view
        )
        mNoNetworkViewResId = typedArray.getResourceId(
            R.styleable.MultipleStatusView_noNetworkView,
            R.layout.no_network_view
        )
        mContentViewResId = typedArray.getResourceId(
